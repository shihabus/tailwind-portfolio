          ...
          <div className="flex-1 lg:py-20 lg:h-screen lg:overflow-y-scroll">
            ...
            <div className="space-y-8 lg:flex flex-col items-center mb-10 lg:mb-24">
              ...
              <div className="my-3 p-6 bg-dusk text-gray-200 rounded-lg lg:w-2/3 transform transition  lg:hover:scale-110 duration-300">
                ...
                <div className="lg tracking-wide text-justify space-y-2 mt-4">
                  <p>
              ...
              {/* ----- bounce ---- */}
              <section className="my-3 p-6 bg-dusk text-gray-200 rounded-lg lg:w-2/3 transform transition  lg:hover:scale-110 duration-300">
                <p className="text-xl font-medium">
            ...
            <div className="space-y-3 lg:space-y-8 md:flex flex-wrap items-baseline mx-auto lg:mt-20 lg:w-3/4 lg:mb-24">
              ...
              <div className="py-2 md:w-1/2">
                ...
                <p className="text-sm lg:text-lg text-gray-400 mt-2">Next.js</p>
              </div>
              <div className="py-2 md:w-1/2">
                <div className="flex space-x-2">
              ...
              <div className="py-2 md:w-1/2">
                ...
                <p className="text-sm lg:text-lg text-gray-400 mt-2">Redux</p>
              </div>
              <div className="py-2 md:w-1/2">
                <div className="flex space-x-2">
                ...
                <p className="text-sm lg:text-lg text-gray-400 mt-2">Webpack</p>
              </div>
            </div>
            {/* ------ skills ------- */}
